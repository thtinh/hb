    ...
    function parceQuote($strQuote=""){
    	...
    	if($strQuote == ""){
    		...
    		if($strName==""){
    			...
    			if($itemID==0){
    				$strResult = '<span class="comment-quotefrom">'.JText::_("Quote from ").'<strong>'.$strName.'</strong>:</span><br />';	
    			}else{
        			...
        			if($item){        				        				
        				...
        				$strResult = '<a href="'.$url.$item->referer.'" class="comment-quotefrom tonus" target="_blank" title="'.JText::_("Click to see orginal").'"><span>'.JText::_("Quote from ").'<strong>'.$strName.'</strong>:</span><br /></a>';					                  			            			                								            	        				
        			}else{
        				$strResult = '<span class="comment-quotefrom">'.JText::_("Quote from ").'<strong>'.$strName.'</strong>:</span><br />';       			        			
        			}        					   				        			        			        			    				
    			}
