       ...
       <div class="plugin_embed form-actions clearfix">
       	<ul class="jac-wrapper-actions">			        								    
    	    ...
    	    <?php if($enableAfterTheDeadline){?>
		    	<li class='form-act-spell'><a href="javascript:jac_check_atd('<?php echo $prefix;?>')" title="<?php echo JText::_("Check Spelling"); ?>"><span id="checkLink<?php echo $prefix;?>"><?php echo JText::_("Check Spelling"); ?></span></a></li>			         
		    <?php } ?>
