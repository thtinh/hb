...
if(!defined('JACOMMENT_GLOBAL_SKIN')){
	...
	JHTML::_('script', 'jquery-1.3.1.js',JURI::root().'components/com_jacomment/asset/js/');
	JHTML::_('script', 'ja.comment.js',JURI::root().'administrator/components/com_jacomment/asset/js/');
	JHTML::_('script', 'jquery.cookie.js',JURI::root().'administrator/components/com_jacomment/asset/js/');
...
if(!JRequest::getVar('view')) JRequest::setVar('view', 'comments');
