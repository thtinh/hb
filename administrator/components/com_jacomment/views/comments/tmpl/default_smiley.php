...
#plugin_embed .smileys .smiley{
    background: url(<?php echo $mainframe->getSiteURL();?>components/com_jacomment/asset/images/smileys/<?php echo $smiley;?>/smileys_bg.png) no-repeat;
    display:block;
    height:20px;   
    width:20px;
}
...
#plugin_embed .smileys .smiley span{
    background: url(<?php echo $mainframe->getSiteURL();?>components/com_jacomment/asset/images/smileys/<?php echo $smiley;?>/smileys.png) no-repeat;
    display: inline;
    float: left;
    height:12px;
    width:12px;
...
<a href="javascript:void(0);" onclick='jacChangeDisplay("smileys-<?php echo $this->cid;?>", "block")'><img src="<?php echo $mainframe->getSiteURL();?>components/com_jacomment/asset/images/smileys/<?php echo $smiley;?>/smileys_icon.png" alt="Smileys" title="<?php echo JText::_('Add a smiley')?>"  /></a>
