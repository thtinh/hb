...
class jacommentViewcomments extends JAView {	
	...
	function changeTypeOfComments() {
		...
		if($statusAll == 1){
			$object [$k]->content = JText::_("[-] Collapse all Comments");					
		}else{
			$object [$k]->content = JText::_("[+] Expand all Comments");
		}
		$k++;
 ...
 // ++ add by congtq 26/11/2009     
    ...
    function showYouTubeLink($id){
        ...
        $document->addScriptDeclaration("jQuery(document).ready( function() { 
                                            jQuery('#".$id."').append('&nbsp;<a href=\"javascript:open_embed();\" class=\"plugin\"><img title=\"Add a YouTube Video\" alt=\"YouTube\" src=\"http://www.youtube.com/favicon.ico\"> <span>".JText::_("Embed Video")."<\/span><\/a>');
                                            
                                        });");
                                        
        $document->addScriptDeclaration("function open_embed(){
                                            jaCreatForm('open_youtube',0,340,300,0,0,'".JText::_("Embed a YouTube Video")."',0,'".JText::_("Embed Video")."');
                                        }");                                                        
    }
    ...
    function showAfterDeadLineLink($id){
        ...
        $document->addScriptDeclaration("jQuery(document).ready( function() { 
                                            jQuery('#".$id."').append('&nbsp;<a href=\"javascript:jac_check_atd(\'\')\"><img title=\"Proofread Comment w/ After the Deadline\" alt=\"AtD\" src=\"http://www.polishmywriting.com/atd_jquery/images/atdbuttontr.gif\"> <span id=\"checkLink\">". JText::_("Check Spelling") ."<\/span><\/a>');
                                        });");
