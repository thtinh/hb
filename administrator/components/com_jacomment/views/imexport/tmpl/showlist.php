...
function selectArticle(selectedlinks, numberOfComment){		
	...
	jaCreatForm('open_content',selectedlinks,600,400,0,0,'<?php echo JText::_("Select an article");?>',0,'<?php echo JText::_("Submit");?>',0);		
}
...
<div class="col100">	
	<div id="ServiceComments">
		<div class="box">
			<h2><?php echo JText::_('Import comments from disqus')?></h2>	
								...
								<div id="page-disqus">
									<div class="comments-top">																															
										<div style="float: right;">											
											<input type="submit" name="btlSubmit" value="<?php echo JText::_("Import now");?>"/>
										</div>
										<div style="float: right;">											
											<label title="<?php echo JText::_("Delete all current Disqus comments");?>"><input type="checkbox" value="1" name="deleteDisqusComment"/> <?php echo JText::_("Delete all current Disqus comments");?></label>
										</div>																	
									</div>
									<?php ?>	
									<table width="100%" border="0" class="tbl tbl_comment" cellpadding="0" cellspacing="0">										
										<tr>
											...
											<td width="16%" align="center"><b><?php echo JText::_("Destination component");?></b></td>
											<td width="19%" align="center"><b><?php echo JText::_("Title");?></b></td>
											<td width="10%" align="center"><b><?php echo JText::_("Select article");?></b></td>
										</tr>
										<?php 
											$i = 0;
											$contentid 		= 0;
											...
											$articleLink 	= "";
											$isCheckAll 	= 1;
											$isExsitComMyblog= $this->checkExistComponent("com_myblog");
										...
										<?php 																																														
											$result  		= $this->getComponentFromAriticle($key, $isExsitComMyblog);																																																																																				 
											if($result){																																																											
												if(isset($result->name) && $result->name == "MyBlog"){
													...
													$contentid 	= $result->id; 
													$articleLink= JRoute::_($route->getArticleRoute($result->id.":".$result->title,$result->catID.":".$result->catTitle));	
												}																												
											}
											//not found article
											else{													
									...
									<div class="comments-top">																																
										<div style="float: right;"><input type="submit" name="btlSubmit" value="<?php echo JText::_("Import now");?>"/></div>
									</div>		
								</div>																
							</div>						
					</li>
