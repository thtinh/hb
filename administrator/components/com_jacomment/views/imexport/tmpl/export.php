			...
			<div class="box_content">
				<ul class="ja-list-checkboxs">
					<li class="row-1 ja-section-title">
						<b><?php echo JText::_("Export for backup");?></b>
					</li>
					<li class="row-0">
						<label>    
							<span class="editlinktip hasTip" title="<?php echo JText::_( 'Max records' );?>::<?php echo JText::_( 'Empty for all' ); ?>">
							<?php echo JText::_("Max records");?>
							</span>
