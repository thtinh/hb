...
function submitbutton(pressbutton){
	...
	if(pressbutton=='add')    
		jaCreatForm("editmoderator&group=moderator",0,500,350,0,0,'<?php echo JText::_("Add User");?>',0,'<?php echo JText::_('Add');?>');
	else{
		...
		<div class="box">
			...
			<div class="box_content">
				...
				<div style="text-align: right;">
					<a id='jac_help' href="index.php" onclick="hiddenNote('moderator','<?php echo JText::_('[Help]')?>','<?php echo JText::_('[Close]')?>');return false;"><?php echo JText::_('[Help]')?></a>
				</div>		
				<?php 
					$note = JText::_( "ADMIN / MODERATOR SETTINGS NOTE" );
				...
				<table class="adminlist" id="user_added">
					...
					for ($i=0;$i<$count; $i++) {
						...
						$title=JText::_('Edit Permission')." ID: ".$item->id;					
						?> 
