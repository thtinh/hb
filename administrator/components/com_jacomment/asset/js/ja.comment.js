	...
	var button_preview = new Element('button', {
											...
											'events': {
												'click': function(e){
                                                    ...
                                                    if(jQuery("#is_enable_threads").is(':checked')) is_enable_threads = 1;                                                       if(jQuery("#is_allow_voting").is(':checked')) is_allow_voting = 1;  
                                                    ...
                                                    url = url+"&is_enable_threads="+is_enable_threads+"&is_allow_voting="+is_allow_voting+"&is_attach_image="+is_attach_image+"&is_enable_website_field="+is_enable_website_field+"&is_enable_autoexpanding="+is_enable_autoexpanding+"&is_enable_email_subscription="+is_enable_email_subscription+"&is_allow_report="+is_allow_report;
