	...
	*/
	function save(){
		...
		if(JFile::exists($path)){
			...
			if ($res) {
				$msg = JText::_( 'SAVE DATA SUCCESSFULLY').': '.$file;
			} else {
				JError::raiseWarning(1001,JText::_("ERROR OCCURRED! DATA NOT SAVED")." ".$file);	
			}			
		}
		else 
			JError::raiseWarning(1001,JText::_("FILE NOT FOUND TO EDIT"));
