...
<div class="span-15 last clearfix">
    ...
    <div id="album-content">
        <div id="title">
            Điều trị cho các trẻ em dị tật Campuchia - Ngày 23/09/2009
        </div>
        <div id="intro">
        ...
        <div id="album-thumbnail">
            <div id="back" style="float:left">
                <img src="images/back-bt.jpg" />
            </div>
            <div id="thumbnail" style="float:left">
                <ul>
                    <li>
                        <img src="images/album-thumbnail.jpg" />
                    </li>
                    <li>
                        <img src="images/album-thumbnail.jpg" />
                    </li>
            ...
            <div id="next" style="float:left">
                <img src="images/next-bt.jpg" />
            </div>
        </div>
        <div id="picture">
            <img src="images/album-pic.jpg" />
        </div>
        <div id="description">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt. (Ảnh: Làng Hòa Bình)
        </div>
    </div>
